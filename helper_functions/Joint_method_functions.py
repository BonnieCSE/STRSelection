        ...
        if return_info == False:
            ...
            if use_common_alleles == True:
                ...
                if abs(obs_common_stats[2] - sim_med_common) < (obs_common_stats[2] + 0.005)/eps_common[2]:
                    ...
                    count_0 = count_0 + 1
                if count_0==6:
                    return True, sim_mean_het, sim_var_het, sim_med_het, sim_mean_common, sim_var_common, sim_med_common, params_accept[0], params_accept[1], params_accept[2], params_accept[3], params_accept[4], params_accept[5]
                else:
                    return False, sim_mean_het, sim_var_het, sim_med_het, sim_mean_common, sim_var_common, sim_med_common, params_accept[0], params_accept[1], params_accept[2], params_accept[3], params_accept[4], params_accept[5]
